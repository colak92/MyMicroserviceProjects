  ...
  <div className="box max-w-4xl">
    ...
    <div className="forms h-full">
      <div className="form-content h-full">
        <div className="login-form" style={{ display: isRegistered ? 'none' : 'block', width: '100%' }}>
          <Signin togglePanel={togglePanel} />
        </div>
        <div className="signup-form" style={{ display: isRegistered ? 'block' : 'none', width: '100%' }}>
    ...
    <div className={`cover ${isRegistered ? 'rotate-active' : ''}`}>
      <div className="front">
        ...
        />
        <div className="text">
          <span className="text-login">Success is built upon well paid jobs</span>
      ...
      <div className="back">
        ...
        />
        <div className="text">
          <span className="text-signup">Join us and start your journey</span>
          <span className="text-signup2 text-xs">Create your account now</span>
        </div>
      </div>
    </div>
